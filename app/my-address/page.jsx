...
export default function Page() {
  ...
  const [editAddress, setEditAddress] = useState(null);
  const [userId, setUserId] = useState(null);
  const [showDrawer, setShowDrawer] = useState(false); // Drawer toggle state
  ...
  return (
    <section className="my_address">
      ...
      <div className="container mar_top">
        {/* Drawer Toggle Button - only on mobile */}
        ...
        <div className="row">
          {/* MyProfile for desktop view */}
          <div className="col-md-4 my_profile d-none d-lg-block">
            <div className="position_fixed">
              <MyProfile />
            </div>
          </div>

          <div className="col-md-8 second_div  mt-lg-4">
            <p id="btn" className="mb-3" onClick={handleAddNewClick}>
              + Add New Address
            </p>
